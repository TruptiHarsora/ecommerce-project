...
const Navbar = ({ setOpen }) => {
  ...
  return (
    <header className="w-full bg-[#131921] text-white px-3 py-2 flex items-center gap-3">
      ...
      {
        <button type="button" onClick={() => setOpen(true)} className="md:hidden p-1 rounded hover:bg-white/10">
      ...
      <div className="flex-1 relative">
        <form onSubmit={handleSubmit}
          ...
          <button type="submit" className="bg-yellow-400 px-4 hover:bg-yellow-500">
            <MagnifyingGlassIcon className="w-5 h-5 text-black" />
          </button>
        </form>
