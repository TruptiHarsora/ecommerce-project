  ...
  if (!orders?.length) {
    return (
      <div className='min-h[60vh flex flex-col items-center justify-center gap-4'>
        <h2 className='text-2xl dont-Semibold'>
          No Orders Found
        </h2>
            ...
            <CardContent className='p-0'>
              <div className='bg-gray-100 px-6 py-4 border-b'>
                ...
                <div className='grid grid-cols-3 gap-4'>
                  ...
                  <div>
                    <p className='text-sm uppercase text-gray-500 font-semibold'>Order Placed</p>
                  ...
                  <div>
                    <p className='text-sm uppercase text-gray-500 font-semibold'>Total</p>
                    <p className='font-medium'>
                  ...
                  <div>
                    <p className='text-sm uppercase text-gray-500 font-semibold'>Status</p>
                    <p className={`inline-flex px-3 py-1 rounded-full text-xs font-medium capitalize
