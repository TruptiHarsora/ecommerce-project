              ...
              <div className="space-y-5">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>{product.sellers?.[0]?.stock}</span>
                  </div>
          ...
          <CardContent>
            ...
            <div className="text-left">
              ...
              <div className="flex gap-2">
                ...
                <p className="capitalize">{seller?.status}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="flex flex-wrap justify-end gap-3">
          {actionType === "admin" && (
            <Button
              ...
              onClick={() => navigate(`${viewUrl}/sellers/${seller._id}`)}
            >
              View Seller
            </Button>
          )}
          ...
          <Button
            className="border-blue-700 bg-blue-100 text-blue-700 hover:bg-blue-200"
            onClick={() => navigate(`${viewUrl}/product/update/${product._id}`)}
          >
            Edit Product
          </Button>
