...
const ProductUpdate = () => {
      ...
      try {
        ...
        const variantPayload = values.variants.map((variant, index) => {
          ...
          if (Array.isArray(variant.attributes)) {
            ...
            // OBJECT FORMAT
            formattedAttributes = variant.attributes || {};
          }
          ...
          return {
            ...
            existingImages:
              variant.variantImages?.filter((img) => typeof img === "string") ||
              [],
          };
        });
  ...
  const removeExistingImage = (index) => {
    const update = formik.values.existingImages.filter((_, i) => i !== index);

    formik.setFieldValue("existingImages", update);
  };
        ...
        <form className="space-y-8" onSubmit={formik.handleSubmit}>
          ...
          <Card className="overflow-visible">
            ...
            <CardContent className="overflow-visible">
              <div className="relative space-y-2">
                ...
                >
                  {categories.find((cat) => cat._id === formik.values.category)
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              {/* NEW IMAGES */}
              <div className="space-y-3">
                <h3 className="font-semibold">New Images Preview</h3>
                ...
                {formik.values.specification.map((spec, index) => (
                  <Card key={index}>
                    <CardContent className="p-4 space-y-2">
                      <p>
                        <strong>Group:</strong> {spec.group}
                      </p>

                      <p>
                        <strong>Key:</strong> {spec.key}
                      </p>

                      <p>
                        <strong>Value:</strong> {spec.value}
                      </p>
