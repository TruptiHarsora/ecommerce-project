      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <Card>
          <CardHeader className="bg-gray">
            <CardTitle className="text-2xl font-bold bg-gray">
              Create Product
            </CardTitle>
          </CardHeader>
        </Card>
            ...
            <CardContent className="overflow-visible">
              <div className="relative space-y-2">
                ...
                {/* <p className="text-sm text-gray-500 mt-1">
                  {" "}
                  Selected ID: {formik.values.category}{" "}
                </p> */}
            ...
            <CardContent className="space-y-5">
              <div className="grid md:grid-cols-4 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    name="key"
                    placeholder="Ex: Display Technology"
                    value={specInput.key}
                    onChange={handleSpecChange}
                  />
                </div>
                ...
                {formik.values.specification.map((spec, index) => (
                  ...
                  >
                    <div className="break-words whitespace-normal">
                      ...
                      <p>
                        <span className="font-semibold">Key:</span> {spec.key}
                      </p>
